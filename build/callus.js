(function () {
	...
	*/
	...
	var phoneIcon = function phoneIcon() {
	  return /*#__PURE__*/react_4("svg", {
	    width: "18",
	    viewBox: "0 0 1792 1792",
	    height: "18",
	    xmlns: "http://www.w3.org/2000/svg"
	  }, /*#__PURE__*/react_4("path", {
	...
	var closeIcon = function closeIcon() {
	  ...
	  }, /*#__PURE__*/react_4("g", null, /*#__PURE__*/react_4("path", {
	...
	var css_248z = ".call-us-wrapper {\n  position: fixed;\n  bottom: 0;\n  right: 0;\n  margin: 0 15px 40px;\n  overflow: hidden; }\n  .call-us-wrapper .call-us-body {\n    text-align: center;\n    background: black;\n    color: white;\n    padding: 20px;\n    border-radius: 16px; }\n  .call-us-wrapper .call-us-text {\n    margin: 0;\n    font-size: 22px;\n    margin-bottom: 15px;\n    font-family: sans-serif; }\n  .call-us-wrapper .call-us-number {\n    background-color: #232e25;\n    margin: 0 20px;\n    border-radius: 50px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    padding: 2px 20px;\n    font-family: cursive;\n    font-weight: bold; }\n    .call-us-wrapper .call-us-number svg {\n      fill: #83c560; }\n    .call-us-wrapper .call-us-number a {\n      color: #83c560;\n      font-size: 20px;\n      padding-left: 10px;\n      text-decoration: none; }\n  .call-us-wrapper .call-us-close-wrapper {\n    float: right;\n    margin-top: 20px;\n    margin-right: 15px;\n    background-color: black;\n    border-radius: 100%;\n    padding: 10px 12px 5px;\n    cursor: pointer; }\n    .call-us-wrapper .call-us-close-wrapper svg {\n      fill: white; }\n";
	styleInject(css_248z);

	var App = function App() {
	  var _React$useState = react_5({}),
	      _React$useState2 = slicedToArray(_React$useState, 2),
	      dataResponse = _React$useState2[0],
	      setDataResponse = _React$useState2[1];

	  react_7(function () {
	    var mount = true;

	    asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	      var response, _response$data, data;
	      ...
	      return regenerator.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              _context.next = 2;
	              return axios$1.get("https://codifyinditest.com/script_test/api-test/ ");
	  ...
	  var onCloseClick = react_6(function () {
	    /**
	     * @note To remove the content assign empty object to response
	     */
	    setDataResponse({});
	  }, []);
	  var _dataResponse$script = dataResponse["script test"];
	  _dataResponse$script = _dataResponse$script === void 0 ? {} : _dataResponse$script;
	  var _dataResponse$script$ = _dataResponse$script.labels,
	      labels = _dataResponse$script$ === void 0 ? "" : _dataResponse$script$,
	      _dataResponse$script$2 = _dataResponse$script.phone_number,
	      phone_number = _dataResponse$script$2 === void 0 ? "" : _dataResponse$script$2;
	  return labels !== "" && /*#__PURE__*/react_4("div", {
	    className: "call-us-wrapper"
	  }, /*#__PURE__*/react_4("div", {
	    className: "call-us-body"
	  }, /*#__PURE__*/react_4("h3", {
	    className: "call-us-text"
	  }, labels), /*#__PURE__*/react_4("div", {
	    className: "call-us-number"
	  }, phoneIcon(), /*#__PURE__*/react_4("a", {
	    href: "tel:".concat(phone_number)
	  }, phone_number))), /*#__PURE__*/react_4("div", {
	    className: "call-us-close-wrapper",
